...
# Created by write_sdc on Tue Dec 14 23:01:03 2021
...
set_driving_cell -lib_cell NAND2X2_LVT -library saed32lvt_tt0p85v25c           \
[get_ports rghtIR_n]
set_load -pin_load 100 [get_ports SS_n]
set_load -pin_load 100 [get_ports SCLK]
set_load -pin_load 100 [get_ports MOSI]
set_load -pin_load 100 [get_ports lftPWM1]
set_load -pin_load 100 [get_ports lftPWM2]
set_load -pin_load 100 [get_ports rghtPWM1]
set_load -pin_load 100 [get_ports rghtPWM2]
set_load -pin_load 100 [get_ports TX]
set_load -pin_load 100 [get_ports piezo]
set_load -pin_load 100 [get_ports piezo_n]
set_load -pin_load 100 [get_ports IR_en]
